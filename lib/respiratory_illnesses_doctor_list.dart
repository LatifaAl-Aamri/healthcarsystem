...
//
// class RespiratoryIllnessesDoctorList extends StatefulWidget {
//   const RespiratoryIllnessesDoctorList({Key? key}) : super(key: key);
//
//   @override
//   _RespiratoryIllnessesDoctorListState createState() =>
//       _RespiratoryIllnessesDoctorListState();
// }
//
// class _RespiratoryIllnessesDoctorListState
//     extends State<RespiratoryIllnessesDoctorList> {
//   // Reference to the "respiratoryillnessesDoctors" node in your Firebase database
//   DatabaseReference resDoctorDb =
//   FirebaseDatabase.instance.ref("respiratoryillnessesDoctors");
//   Query resDoctorQuery =
//   FirebaseDatabase.instance.ref().child('respiratoryillnessesDoctors');
//
//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
//       appBar: AppBar(
//         title: const Text('Respiratory Illnesses Doctors List'),
...
//   }
//
//   // Build a card for each respiratory doctor
...
//             children: [
//               // Doctor image (or icon if no image provided)
//               ClipRRect(
...
//
//   // Launches Google Maps using the hospital location URL
...
//         // Make the page scrollable if content overflows
//         child: Padding(
...
//                   ),
//                   const SizedBox(height: 12),
//                   // Horizontally scrollable link for the location
